...
// @desc    Create Post
// @access  Private
router.post("/", [auth, validationPost], async (req, res) => {
...
router.put("/like/:id", auth, async (req, res) => {
	try {
		...
		// Add like to post
		post.likes.unshift({ user: req.user.id }); // unshift method just like push but it start beginning
...
router.delete("/comment/:id/:comment_id", auth, async (req, res) => {
	try {
		...
		// Make sure user log in deleting comment
